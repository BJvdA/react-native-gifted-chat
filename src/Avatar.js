  ...
  renderAvatar() {
    ...
    return (
      <GiftedAvatar
        ...
        senderId={this.props.currentMessage.senderId}
        sender={this.props.currentMessage.sender}
        onPress={() => this.props.onPressAvatar && this.props.onPressAvatar(this.props.currentMessage.senderId)}
      />
    );
  }
